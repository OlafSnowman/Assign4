...
public abstract class UpperCaseOperationTestSuite {

  Writer writer;

  protected abstract Writer createWriterWithUpperCaseOperation() throws IOException;

  @BeforeEach
  public void init() throws IOException {
    writer = createWriterWithUpperCaseOperation();
  }
